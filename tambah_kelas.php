...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <ul class="navbar-nav">
    ...
    <h3>Tambah Kelas | <a href="tampil_siswa.php?" onclick="return confirm('Apakah anda yakin berhenti menambahkan daftar kelas?')" class="btn btn-danger">Keluar</a></td></h3>
