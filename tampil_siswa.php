...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <ul class="navbar-nav">
    ...
    <h3>Tampil Siswa | <td><a href="tambah_siswa.php" onclick="return confirm('Apakah anda yakin untuk menambah daftar siswa?')" class="btn btn-success">Tambah Siswa</a></td></h3>
